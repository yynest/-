...
- (id)init {
	...
	if (self) {
        ...
        _backgroundColor = [UIColor colorWithWhite:1.0 alpha:1.0];
        ...
        _titleColor= [UIColor colorWithRed:64/255.0 green:64/255.0 blue:64/255.0 alpha:1.0];
		
        _titleFont = [ToolFontFit getFontNormalSizeWithType:NormalFontTypeTitle];
		
		_messageMargins = DLAVTextControlMarginsMake(-5.0, 18.0, 10.0, 10.0);
		_messageColor = [UIColor grayColor];
		_messageFont = [ToolFontFit getFontNormalSizeWithType:NormalFontTypeMainbody1];
        ...
        [_primaryButtonTheme setBackgroundColor:[UIColor colorMainGreen]];
        [_primaryButtonTheme setHighlightBackgroundColor:[UIColor colorClikcdBTGreen]];
        
		_otherButtonTheme = [[[DLAVAlertViewButtonTheme alloc] init] themeWithRegularSystemFont];
        //专门设置了cancel button 的风格，白底 蓝字
        [_otherButtonTheme setBackgroundColor:[UIColor whiteColor]];
        [_otherButtonTheme setHighlightBackgroundColor:[UIColor colorClikcdBTGreen]];
        [_otherButtonTheme setTextColor:[UIColor colorMainGreen]];
	}
