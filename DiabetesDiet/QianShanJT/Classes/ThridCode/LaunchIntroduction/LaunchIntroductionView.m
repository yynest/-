...
-(BOOL )isFirstLauch{
    ...
    NSString *currentAppVersion = infoDic[@"CFBundleVersion"];//CFBundleShortVersionString
...
-(void)createScrollView{
    ...
    for (int i = 0; i < images.count; i ++) {
        ...
        if (kScreen_height == 480) {
            str = [str stringByAppendingString:@"_960"];
        }
        ...
        if (i == images.count - 1) {
            ...
            if (!isScrollOut) {
                ...
                [enterButton setImage:[UIImage imageNamed:[enterBtnImage stringByAppendingString:@"_nor"]] forState:UIControlStateNormal];
                [enterButton setImage:[UIImage imageNamed:[enterBtnImage stringByAppendingString:@"_sel"]] forState:UIControlStateHighlighted];
